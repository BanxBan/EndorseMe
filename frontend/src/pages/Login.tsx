    ...
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', background: 'var(--bg)' }}>
      <div style={{ background: 'var(--surface)', padding: '40px', borderRadius: 'var(--radius)', boxShadow: 'var(--shadow-lg)', width: '100%', maxWidth: '400px' }}>
        <div style={{ textAlign: 'center', marginBottom: '30px' }}>
          ...
          <p className="topbar-subtitle" style={{ color: 'var(--text-muted)' }}>Admin Login</p>
        </div>
        ...
        <form onSubmit={handleLogin}>
          ...
          <button type="submit" className="btn btn-primary btn-full" style={{ marginTop: '20px' }}>Login</button>
        </form>
      </div>
    </div>
  );
